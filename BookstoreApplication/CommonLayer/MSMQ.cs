        ...
        private void MessageQueue_ReceiveCompleted(object sender, ReceiveCompletedEventArgs e)
        {
            try
            {
                ...
                SmtpClient smtpClient = new SmtpClient("smtp.gmail.com")
                {
                    Port = 587,
                    EnableSsl = true,
                    Credentials = new NetworkCredential("ishaanbhardwaj410@gmail.com", "jzpjkcvhtbypighu")
                };
                mailMessage.From = new MailAddress("ishaanbhardwaj410@gmail.com");
                ...
                string mailBody = $"<!DOCTYPE html>" +
                                  ...
                                  $".blink" +
                                  $"</style>" +
                                    $"<body style = \"background-color:#FFB6C1;text-align:center;padding:5px;\">" +
                                    ...
                                    $"<a style = \"color:#00802b; text-decoration: none; font-size:20px;\" href='http://localhost:4200/reset/{token}'>Click me</a>\n" +
                ...
                mailMessage.Subject = "Bookstore User Password Reset Link";
